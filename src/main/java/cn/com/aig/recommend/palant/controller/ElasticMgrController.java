...
import cn.com.aig.recommend.palant.utils.ElasticUtil;
import cn.com.aig.recommend.palant.vo.ElasticDataVo;
import cn.com.aig.recommend.palant.vo.QueryVo;
import cn.com.aig.recommend.service.BaseElasticService;
import cn.com.aig.recommend.service.LocationService;
...
public class ElasticMgrController {
    ...
    public void addLocationPage(int pageNum,int pageSize,String index,int lv){
        ...
        List<Location> locations =  new ArrayList<>(); //locationService.getList2(location);
